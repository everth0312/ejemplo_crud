...
if (!empty($_POST['btnregistrar'])) { //si el boton registrar no esta vacio
    ...
    and !empty($_POST['correo'])) {;
        ...
        $sql =$conexion->query("UPDATE personas SET nombre='$nombre', apellido='$apellido', dni='$dni', fecha_nacimiento='$fecha_nacimiento', correo='$correo' WHERE Id = $Id"); //modificar datos de la tabla personas
        if ($sql==1) {
